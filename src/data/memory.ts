...
Это чувство лишний раз доказало мне - что вы не просто команда, вы - моя маленькая семья. Вы - самые лучшие, в моем сердце вы останетесь такими навсегда. Спасибо вам за эту семью!!!!!!!!!!!!!!`,
  },
  {
    id: "dayana",
